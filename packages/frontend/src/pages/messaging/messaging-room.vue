...
>
	...
	<footer :class="$style.footer">
		...
		<Transition :name="animation ? 'fade' : ''">
			<div v-show="showIndicator" :class="$style.new_message">
				<button class="_buttonPrimary" @click="onIndicatorClick" :class="$style.new_message_button">
					<i class="fas ti-fw fa-arrow-circle-down" :class="$style.new_message_icon"></i>{{ i18n.ts.newMessageExists }}
				</button>
			</div>
		</Transition>

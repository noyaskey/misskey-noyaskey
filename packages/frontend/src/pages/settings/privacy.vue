...
<div class="_gaps_m">
	...
	<MkSwitch v-if="!carefulRemote && !carefulBot && !carefulMassive" v-model="isLocked" @update:modelValue="save()">{{ i18n.ts.makeFollowManuallyApprove }}<template #caption>{{ i18n.ts.lockedAccountInfo }}</template></MkSwitch>
